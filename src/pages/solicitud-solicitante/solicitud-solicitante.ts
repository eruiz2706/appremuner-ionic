...
@IonicPage() 
@Component({
  selector: 'page-solicitud-solicitante',
  templateUrl: 'solicitud-solicitante.html',
})
export class SolicitudSolicitantePage {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad SolicitudSolicitantePage');
  }
  ...
  cargarTabla(){
    //this.presentLoading("Cargando...");
    this.auth.getVacacionesHistorial(
      this.usr.token_app,
    ...
    {
      //this.loading.dismiss();
      //this.presentAlert("Se presento un inconveniente al intentar cargar");
    });
  }
